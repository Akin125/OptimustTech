        ...
        <>
            ...
            <div className="privacyBody">
                ...
                <p className="privacyMain">
                    At OptimustTechAcademy, we are committed to providing excellent support to our students. We are
                ...
                <p className="privacyMain">
                    ...
                    office hours. Visit<a className='link-d ffs' href=""><span className="makekHighlight"> [link to contact] </span> </a> for a live chat with the support team.
                ...
                <p className="privacyMain">
                    ...
                    technical support team <a className='link-d ffs' href=""><span className="makekHighlight"> [link to contact] </span> </a>. We are available to
                ...
                <p className="privacyMain">
                    ...
                    and are dedicated to providing outstanding support throughout your journey at OptimustTechAcademy. Don't hesitate to reach out to us whenever you need assistance.
